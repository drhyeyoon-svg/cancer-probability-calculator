...
const riskFactorData = {
    ...
    "가족력/유전": [
        { cancer: "유방암(BRCA1/2)", effect: 5.0 },
        { cancer: "난소암(BRCA1/2)", effect: 6.0 },
        { cancer: "대장암(Lynch, 가족력)", effect: 2.0 },
        { cancer: "전립선암(BRCA2)", effect: 2.6 },
        { cancer: "췌장암(BRCA2, 가족력)", effect: 2.0 }
    ],
    "담석증": [
